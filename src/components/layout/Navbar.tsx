          ...
          <ul className="hidden md:flex items-center gap-6" role="list">
            {NAV_LINKS.map(({ label, href }) => (
              <li key={href}>
                <a
                  href={href}
                  className="text-sm text-offwhite hover:text-cream transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber rounded px-1"
                >
                  {label}
                </a>
              </li>
          ...
          {NAV_LINKS.map(({ label, href }) => (
            <li key={href}>
              <a
                ...
                className="block py-3 text-offwhite hover:text-cream text-base transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber rounded px-1"
              >
                {label}
              </a>
            </li>
